...
_STOP = {
    "a", "ability", "across", "an", "and", "are", "as", "at", "be", "been", "build", "built",
    "by", "can", "could", "did", "do", "does", "etc", "experience", "for", "from", "had", "has",
    "have", "he", "her", "his", "in", "including", "into", "is", "it", "its", "may", "might",
    "must", "no", "not", "of", "on", "or", "our", "over", "per", "role", "she", "should",
    "strong", "team", "teams", "that", "the", "their", "them", "these", "they", "this", "those", "to",
    "under", "use", "used", "using", "via", "was", "we", "were", "will", "with", "work", "working",
...
def _gemini_embed(texts: list[str]) -> list[list[float]]:
    ...
    from resumaker.observability.cost import check_gemini, record

...
from resumaker.ats import rank_skills
from resumaker.config import get_settings
from resumaker.domain import GapReport, JobPosting, KeywordSet, ResumeContent, ResumeDoc
from resumaker.stages.gap import analyze_gaps
from resumaker.stages.keywords import extract_keywords
from resumaker.stages.location import resolve_location
from resumaker.stages.resume.render_docx import render_docx
from resumaker.stages.resume.render_pdf import docx_to_pdf, page_count
from resumaker.stages.resume.tailor import tailor_resume

_OUT = get_settings().output_root

...
REPO_ROOT = prof.REPO_ROOT
HOUSE_RULES_PATH = REPO_ROOT / "data" / "profile" / "house_rules.json"
ENRICH_LOG_PATH = REPO_ROOT / "data" / "cache" / "enrichment_log.jsonl"
...
def update_profile_fact(path: list, value: Any, reason: str, *,
    ...
    profile_path = profile_path or prof.PROFILE_PATH

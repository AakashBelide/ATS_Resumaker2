...
from core.schemas import FitScore, GapReport, JobPosting
...
if __name__ == "__main__":
    ...
    print(f"deterministic={fs.deterministic_0_100}  llm={fs.llm_0_100}  "
          f"FINAL={fs.final_0_100}/100 ({fs.final_1_5}/5)")
    print("dimensions:", fs.dimensions)
    print("why:", fs.rationale)

...
from core.schemas import ResumeContent, VerifyReport
...
if __name__ == "__main__":
    import json
    import sys
    from core.schemas import ResumeContent as RC
    content = RC(**json.load(open(sys.argv[1])))
    rep = verify_resume(content)
    print("PASSED" if rep.passed else "BLOCKED")
    for b in rep.blockers:
        print("  BLOCK:", b)
    for w in rep.warnings:
        print("  warn :", w)
    print("checks:", rep.checks)

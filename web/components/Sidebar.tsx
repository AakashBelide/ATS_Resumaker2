...
const NAV = [
  ...
  { href: "/profile-agent", label: "Assistant", idx: "05", icon: <><path d="M13 3l1.6 4.4L19 9l-4.4 1.6L13 15l-1.6-4.4L7 9l4.4-1.6L13 3z" /><path d="M6.5 13.5l.8 2.2 2.2.8-2.2.8-.8 2.2-.8-2.2-2.2-.8 2.2-.8.8-2.2z" /></> },
